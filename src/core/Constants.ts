...
export const MULTER_TEMP_DIR = 'tmp/uploads'
export const FIREBASE_STORAGE_IMAGES_DIR = 'images'
export const REDIS_DATA_CACHE_EXPIRATION_IN_MILLIS = 120000 // 2 minutes
